...
outcome_path = paste0(protname,'_',dataset,'_harmonized.txt')
exp_path = paste0(protname,'_',dataset,'_GWAS_harmonized.txt')
#exp_path = paste0(protname,'_',dataset,'_chrALL_clumped_withmeta_GWAS-t2dtoprotein.txt')
#outcome_path = paste0(protname,'_',dataset,'_chrALL_clumped_withmeta-t2dtoprotein.txt')
