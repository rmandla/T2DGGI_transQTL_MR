...
mr_name <- paste0(output_dir, protname, ".",dataset,".fstat.steig.mr.txt")
write.table(mr_results, file=mr_name, sep = '\t', quote = F)

# odds ratio
OR <- generate_odds_ratios(mr_results)
OR_name <- paste0(output_dir, protname, ".",dataset,".fstat.steig.or.txt")
write.table(OR, file=OR_name, sep = '\t', quote = F, row.names = F)

# scatter plot
pdf_name <- paste0(output_dir, protname, ".",dataset,".fstat.steig.scatter.pdf")
...
tryCatch({ 
  ...
  pleio_name <- paste0(output_dir,protname, ".",dataset,".fstat.steig.pleio.txt")
...
tryCatch({ 
  ...
  hetero_name <- paste0(output_dir,protname, ".",dataset,".fstat.steig.hetero.txt")
...
steiger_name <- paste0(output_dir, protname, ".",dataset,".fstat.steig.steiger.txt")
